...
class User(AbstractUser):
    ...
    birthday = models.CharField(max_length=20, default='2001-01-01')
    job_number = models.CharField(max_length=10, default='0001')

    zhengzhi_mianmao = models.CharField(max_length=10, default='群众')
    zhengzhi_shijian = models.CharField(max_length=20, default='2020-01-01')

    job = models.CharField(max_length=30, default='软件工程师')
    job_time = models.CharField(max_length=20, default='2020-07-01')

    xueli = models.CharField(max_length=30, default='本科')
    school = models.CharField(max_length=30, default='武汉大学')
    graduate_time = models.CharField(max_length=20, default='2022-06-01')
    team_belong = models.CharField(max_length=20, default='C401')

    phone = models.CharField(max_length=30, default='12345799315')
